    ...
    >
      {isHidden ? (
        ...
        >
          ...
          <h3>Contents</h3>
          <a href="#upgrades" onClick={(e) => handleLinkClick(e, "#upgrades")}>
            <div className={styles.contentLink}>
              <p>Upgrades and Migration</p>
            </div>
          </a>
          <a
            href="#migrating-away"
            onClick={(e) => handleLinkClick(e, "#migrating-away")}
          >
            <div className={styles.contentLink}>
              <p>Migrating Away</p>
            </div>
          ...
          <a
            href="#excel-help"
            onClick={(e) => handleLinkClick(e, "#excel-help")}
          >
            <div className={styles.contentLink}>
          ...
          <a
            href="#upgrade-issues"
            onClick={(e) => handleLinkClick(e, "#upgrade-issues")}
          >
            <div className={styles.contentLink}>
              <p>Upgrade Issues</p>
            </div>
