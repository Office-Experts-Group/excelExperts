    ...
    >
      {isHidden ? (
        ...
        >
          ...
          <h3>Add Ins</h3>
          <a href="#created" onClick={(e) => handleLinkClick(e, "#created")}>
            <div className={styles.contentLink}>
              <p>Created in Excel</p>
            </div>
          </a>
          <a href="#vsto" onClick={(e) => handleLinkClick(e, "#vsto")}>
            <div className={styles.contentLink}>
              <p>Created in VSTO</p>
            </div>
          </a>
          <a
            href="#which-is-best"
            onClick={(e) => handleLinkClick(e, "#which-is-best")}
          >
            <div className={styles.contentLink}>
              <p>Which Is Best for You?</p>
            </div>
          </a>
          <a href="#build" onClick={(e) => handleLinkClick(e, "#build")}>
            <div className={styles.contentLink}>
              <p>We Can Build Yours!</p>
            </div>
          </a>
        </div>
      )}
