...
const schema = {
  ...
  "@graph": [
    ...
    generateOrganizationSchema(),
    {
      ...
      name: "Excel-Integrated Word Templates | Corporate Document Solutions | Excel Experts",
      isPartOf: {
      ...
      breadcrumb: {
        "@id":
          "https://www.excelexperts.com.au/services/microsoft-word/corporate-identity/#breadcrumb",
      },
      inLanguage: "en-AU",
      potentialAction: [
        {
