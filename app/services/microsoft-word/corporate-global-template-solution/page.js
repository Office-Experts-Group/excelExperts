...
const schema = {
  ...
  "@graph": [
    ...
    generateOrganizationSchema(),
    {
      ...
      name: "Corporate Word Solutions | Excel-Integrated Corporate Templates | Excel Experts",
      isPartOf: {
      ...
      breadcrumb: {
        "@id":
          "https://www.excelexperts.com.au/services/microsoft-word/corporate-global-template-solution/#breadcrumb",
      },
      inLanguage: "en-AU",
      potentialAction: [
        {
