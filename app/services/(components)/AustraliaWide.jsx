      ...
      >
        <AnimateOnScroll animation="fade-up" duration={1} delay={0}>
          <div className={styles.content}>
            ...
            <p style={{ zIndex: "10" }}>
              Excel Experts provides comprehensive Microsoft Excel consulting
              ...
              timely, professional spreadsheet solutions wherever you're
              located. Whether you need a quick consultation, VBA automation, or
              full-scale custom Excel development, our team ensures you receive
              expert support with minimal travel costs and maximum efficiency.
            </p>
          </div>
        </AnimateOnScroll>
