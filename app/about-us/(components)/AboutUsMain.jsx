      ...
      <AnimateOnScroll animation="slide-right" delay={0} duration={1}>
        <div className={styles.content}>
          <div className={styles.underline}>
            <p>Your Excel Specialists</p>
          </div>
          <h2>Excel Consulting, Development and Automation Australia</h2>
          <p className={styles.themeText}>
            Our skilled consultants and developers bring deep expertise in
            Microsoft Excel for both Mac and PC, across all major versions
            including Excel 2000 to 2016 and Microsoft 365.
          </p>
