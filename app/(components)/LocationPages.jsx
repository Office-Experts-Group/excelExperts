        ...
        <AnimateOnScroll animation="fade-up" duration={1} delay={0.3}>
          <div className={styles.content}>
            ...
            <p>
              ...
              solutions. We deliver exceptional results in data management,
              automated reporting, complex calculations, and interactive
              visualisation dashboards.
            </p>
            <p>
              Through our extensive and growing customer base, our highly
              experienced Microsoft Excel consulting team is renowned for data
              optimisation, responsive technical support, innovative macro
              development, customised training programs, and comprehensive
              implementation of Excel-based business solutions from basic
              spreadsheets to complex enterprise systems.
            </p>
          </div>
